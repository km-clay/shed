use nix::{libc::STDOUT_FILENO, sys::resource::{UsageWho, getrusage}, unistd::write};

use crate::{libsh::error::ShResult, parse::{NdRule, Node}, procio::borrow_fd, state::{self, CmdTimer}};
