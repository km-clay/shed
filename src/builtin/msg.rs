use crate::{
  builtin::join_raw_args, getopt::{Opt, OptSpec, get_opts_from_tokens}, libsh::error::{ShErr, ShErrKind, ShResult}, parse::{NdRule, Node}, prelude::*, procio::borrow_fd, state::{self, write_meta}
};
